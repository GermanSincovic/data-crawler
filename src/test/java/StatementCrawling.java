...
public class StatementCrawling extends Crawling {
  ...
  public static void main() {
    ...
    Arrays.stream(data).forEach(bankStatement -> {
      ...
      dbStatement.setAmount(bankStatement.getAmount());
      ...
      dbStatement.setCurrencyCode(CurrencyCodeISO4217.getNameByCode(bankStatement.getCurrencyCode()));
